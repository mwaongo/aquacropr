...
.create_readme <- function(path, dirs = .AQUACROP_DIRS, version = NULL, pkg_name = "aquacroptools") {
  ...
  readme_content <- c(
    ...
    "",
    "Documentation: https://github.com/mwaongo/aquacroptools",
    ...
    "  Website: https://github.com/mwaongo/aquacroptools",
    ...
    "",
    paste0("Waongo, M., Ouedraogo, O.A.Y. (2025). aquacroptools: R Tools for the FAO AquaCrop"),
