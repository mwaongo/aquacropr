...
aquacroptools is a set of tools specifically developed to work with
AquaCrop v7.0 (August 2022) files. AquaCrop is a crop-water productivity
model developed by the Food and Agriculture Organization (FAO) of the
United Nations. It is used to simulate and evaluate the response of
various crops to water availability and provides insights into crop
water requirements, yield potential, and water productivity.

aquacroptools is designed to make Aquacrop v7.0 files handling much
easier and allow users to programmatically :
